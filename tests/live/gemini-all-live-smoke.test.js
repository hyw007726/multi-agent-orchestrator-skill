...
test("gemini lower-model reviewer, arbitrator, and worker complete the all-live protocol", { timeout: 16 * 60 * 1000 }, async (t) => {
  const result = await runAllLiveSmoke(t, "gemini");
