...
const PROVIDERS = ["claude", "codex", "gemini", "kilo", "opencode"];
...
function usage() {
  return [
    "Usage:",
    "  RUN_LIVE_MODEL_TESTS=1 node scripts/run-live-tests.js [--provider all|claude|codex|gemini|kilo|opencode|mixed]",
    "",
