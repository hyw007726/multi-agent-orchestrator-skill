...
- **[DONE C3] Add a `prepare-run.js` starter pipeline**
...
- **[DONE C2] Generate `coord/context.json` and `coord/DECISIONS.md` from a reviewed plan**
...
- **[DONE C2] Add strict context and task validation before launch**
...
- **[DONE C2] Persist richer caller context for the headless loop**
...
- **[DONE C2] Make `launch-all.js` surface starter-session quality issues**
